...
export type CommentatorQuestionMutationVariables = {
  History: string,
  SessionID: string,
  Comment: string,
  Board: string,
...
export type CommentatorQuestionMutation = {
  commentatorQuestion?:  {
    __typename: "Comment",
    SessionID: string,
    SK?: string | null,
...
export type SendErrorMutationVariables = {
  input: ErrorResponseInput,
};

export type SendErrorMutation = {
  sendError?:  {
    __typename: "ErrorResponse",
    SessionID: string,
    Error?: string | null,
...
export type OnSendErrorSubscriptionVariables = {
  SessionID?: string | null,
};

export type OnSendErrorSubscription = {
  onSendError?:  {
    __typename: "ErrorResponse",
    SessionID: string,
    Error?: string | null,
