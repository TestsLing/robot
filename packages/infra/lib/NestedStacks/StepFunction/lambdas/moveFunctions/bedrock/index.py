...
def predict_next_move(model_id, san_list, board):
    ...
    system_prompts = [
        {
            "text": "You are a chess commentator providing concise justifications for moves. Analyze moves based on the current board position (FEN) and active color. Do not restate the board in the response."
        }
    ]
