...
>;
export const commentatorQuestion = /* GraphQL */ `mutation CommentatorQuestion(
  $History: AWSJSON!
  $SessionID: ID!
  $Comment: String!
  $Board: String!
...
` as GeneratedMutation<
  APITypes.CommentatorQuestionMutationVariables,
  APITypes.CommentatorQuestionMutation
>;
export const sendError = /* GraphQL */ `mutation SendError($input: ErrorResponseInput!) {
...
` as GeneratedMutation<
  APITypes.SendErrorMutationVariables,
  APITypes.SendErrorMutation
>;
