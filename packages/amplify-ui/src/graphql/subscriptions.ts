...
>;
export const onSendError = /* GraphQL */ `subscription OnSendError($SessionID: String) {
  onSendError(SessionID: $SessionID) {
    SessionID
    Error
    Cause
    __typename
...
` as GeneratedSubscription<
  APITypes.OnSendErrorSubscriptionVariables,
  APITypes.OnSendErrorSubscription
>;
